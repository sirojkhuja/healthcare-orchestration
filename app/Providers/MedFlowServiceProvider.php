...
use App\Modules\Integrations\Infrastructure\Persistence\DatabaseTelegramWebhookDeliveryRepository;
...
use App\Modules\Notifications\Infrastructure\Integrations\ConfigSmsProviderRegistry;
use App\Modules\Notifications\Infrastructure\Integrations\ConfiguredEmailGateway;
use App\Modules\Notifications\Infrastructure\Integrations\ConfiguredTelegramBotGateway;
use App\Modules\Notifications\Infrastructure\Persistence\DatabaseEmailEventRepository;
use App\Modules\Notifications\Infrastructure\Persistence\DatabaseEmailProviderSettingsRepository;
...
use App\Modules\Notifications\Infrastructure\Persistence\DatabaseSmsRoutingRepository;
use App\Modules\Notifications\Infrastructure\Persistence\DatabaseTelegramProviderSettingsRepository;
...
use App\Modules\Scheduling\Infrastructure\Persistence\DatabaseAppointmentNoteRepository;
use App\Modules\Scheduling\Infrastructure\Persistence\DatabaseAppointmentNotificationRepository;
use App\Modules\Scheduling\Infrastructure\Persistence\DatabaseAppointmentParticipantRepository;
use App\Modules\Scheduling\Infrastructure\Persistence\DatabaseAppointmentRecurrenceRepository;
...
use App\Modules\Scheduling\Infrastructure\Persistence\DatabaseWaitlistRepository;
...
final class MedFlowServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(AuditRetentionPruner::class, DatabaseAuditRetentionPruner::class);
        ...
        $this->app->bind(TelegramWebhookDeliveryRepository::class, DatabaseTelegramWebhookDeliveryRepository::class);
        ...
        $this->app->bind(EmailEventRepository::class, DatabaseEmailEventRepository::class);
        $this->app->bind(EmailGateway::class, ConfiguredEmailGateway::class);
        $this->app->bind(EmailProviderSettingsRepository::class, DatabaseEmailProviderSettingsRepository::class);
        $this->app->bind(NotificationRepository::class, DatabaseNotificationRepository::class);
        $this->app->bind(NotificationQueueGateway::class, NotificationDispatchService::class);
        $this->app->bind(SmsProviderRegistry::class, ConfigSmsProviderRegistry::class);
        $this->app->bind(SmsRoutingRepository::class, DatabaseSmsRoutingRepository::class);
        $this->app->bind(TelegramBotGateway::class, ConfiguredTelegramBotGateway::class);
        $this->app->bind(TelegramProviderSettingsRepository::class, DatabaseTelegramProviderSettingsRepository::class);
        ...
        $this->app->bind(PiiFieldRepository::class, DatabasePiiFieldRepository::class);
        ...
        $this->app->bind(AppointmentNoteRepository::class, DatabaseAppointmentNoteRepository::class);
        $this->app->bind(AppointmentNotificationRepository::class, DatabaseAppointmentNotificationRepository::class);
        $this->app->bind(AppointmentParticipantRepository::class, DatabaseAppointmentParticipantRepository::class);
        $this->app->bind(AppointmentRecurrenceRepository::class, DatabaseAppointmentRecurrenceRepository::class);
        ...
        $this->app->bind(WaitlistRepository::class, DatabaseWaitlistRepository::class);
