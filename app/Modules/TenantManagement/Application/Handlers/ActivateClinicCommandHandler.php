...
final class ActivateClinicCommandHandler
{
    public function __construct(
        private readonly ClinicAdministrationService $clinicAdministrationService,
    ) {}

    public function handle(ActivateClinicCommand $command): ClinicData
    {
        return $this->clinicAdministrationService->activateClinic($command->clinicId);
    }
}
